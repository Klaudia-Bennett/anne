...
<main>
    <section class="error">
        <div class="error__inner">
            <h2 class="error__title">ERROR / 404 Not found</h2>
            <p class="error__text">大変申し訳ございません。指定されたURLは存在しておりません。<br>
            入力されたURLに間違いがないかもう一度ご確認ください。</p>
        </div>
    </section>
    <section class="news">
                <div class="news__inner">
                    <h2 class="news__search-title">
                        当サイトでは、以下のような記事が投稿されています♪
                        </h2>
                                                                    <ul class="news__list">
                                                                                                                                <?php
